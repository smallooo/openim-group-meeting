...
class GroupControlsView extends StatefulWidget {
  const GroupControlsView({
    Key? key,
  ...
  @override
  State<GroupControlsView> createState() => _GroupControlsViewState();
}


class _GroupControlsViewState extends State<GroupControlsView> {
  ...
  void initState() {
    ...
    widget.callStateStream.listen(_onChangedCallState);
