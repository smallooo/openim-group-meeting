class ImageRes {
  ...
  static const homeTab1Nor = "$_dir/tk_home_tab1_nor.png";
  // static const homeTab2Nor = "$_dir/ic_home_tab2_nor.webp";
  static const homeTab2Nor = "$_dir/tk_home_tab2_nor.png";
  // static const homeTab3Nor = "$_dir/ic_home_tab3_nor.webp";
  static const homeTab3Nor = "$_dir/tk_home_tab3_nor.png";
  // static const homeTab4Nor = "$_dir/ic_home_tab4_nor.webp";
  static const homeTab4Nor = "$_dir/tk_home_tab4_nor.png";
  // static const homeTab1Sel = "$_dir/ic_home_tab1_sel.webp";
  static const homeTab1Sel = "$_dir/tk_home_tab1_sel.png";
  // static const homeTab2Sel = "$_dir/ic_home_tab2_sel.webp";
  static const homeTab2Sel = "$_dir/tk_home_tab2_sel.png";
  // static const homeTab3Sel = "$_dir/ic_home_tab3_sel.webp";
  static const homeTab3Sel = "$_dir/tk_home_tab3_sel.png";
  // static const homeTab4Sel = "$_dir/ic_home_tab4_sel.webp";
  static const homeTab4Sel = "$_dir/tk_home_tab4_sel.png";
  ...
  static const liveArrowlUp = "$_dir/ic_live_arrow_up.png";
  ...
  static const homeLeftSide = "$_dir/tk_im_home_left_side.png";
  static const homeRightSide = "$_dir/tk_im_home_right_add.png";
  static const homeChatOnline = "$_dir/tk_im_home_chat_online.png";
  static const tkFind1 = "$_dir/tk_find_1.png";
  static const tkFind2 = "$_dir/tk_find_2.png";
  static const tkFind3 = "$_dir/tk_find_3.png";
  static const tkImAudio = "$_dir/tk_im_audio.png";
  static const tkImVideo = "$_dir/tk_im_video.png";
  static const onboarding_checkity_illustration = "$_dir/onboarding_checkity_illustration.png";
  static const onboarding_fingertips_illustration = "$_dir/onboarding_fingertips_illustration.png";
  static const onboarding_swiftshare_illustration = "$_dir/onboarding_swiftshare_illustration.png";
  static const dkyx_icon = "$_dir/dkyx_icon.png";
  static const google_icon = "$_dir/google_icon.png";
  static const telegram_icon = "$_dir/telegram_icon.png";
