const Map<String, String> zh_CN = {
  ...
  "pleaseSelectCallUser": "请选择至少一个用户进行通话",
  ...
  "createGroupPhoneCallNtf": "%s 发起了语音通话",
  "createGroupPhoneVideoNtf": "%s 发起了视频通话",
  ...
  "createGroup": "创建群聊",
  "createGroupHint": "创建群聊，全面使用TokLink",
  "addGroup": "添加群聊",
  ...
  'search_by_phone_and_uid': '通过ID号搜索添加',
