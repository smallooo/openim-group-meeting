const Map<String, String> en_US = {
  ...
  "createGroupHint": "Create a group, fully utilize TokLink",
  "addGroup": "Add Group",
  ...
  'search_by_phone_and_uid': 'search by phone',
...
const Map<String, String> errorMessages = {
  ...
  "tok_link": "TokLink",
  "tok_link_des": "Where Hearts Connect,\n Love Finds its Sync.",
  'Please_Enter_Your_Email': 'Please Enter Your Email',
  'Log_in': 'Log in',
  'OR_CONTINUE_WITH': 'OR CONTINUE WITH',
  'By_signing_up_our_Privacy_Policy':
  'By signing up you agree to our Terms and Conditions\nSee how we use your data in our Privacy Policy',
  'Verify_your_email': 'Verify your email',
  'Verify_your_email_tip':
  'Please enter the verification code we sent to\nyour email address to complete the\nverification process.',
  'resend_code': 'Resend the code',
  'nice_to_see_you': 'Nice to see you!',
  'your_name_tip': 'Hey, what name should l callyou?',
  'enter_your_name': 'Enter your name',
  'next': 'Next',
  'email_format_incorrect': 'Email format incorrect',
};
