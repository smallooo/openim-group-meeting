...
class StrategyUnionMemberProfileState {
  ...
  bool isFollowing = false; // 是否已关注，默认false
...
4. 资金和心态：建议3000U以上资金操作适合盈利，保持耐心、信任、稳定心态，学会交易''';
  ...
  // 策略列表数据
  List<TraderStrategyItem> strategiesList = [];
  bool isLoadingStrategies = false;
  String strategiesError = '';
  int strategiesCurrentPage = 1;
  bool hasMoreStrategies = true;
