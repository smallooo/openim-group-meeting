...
class TkPaySetPassWordBinding extends Bindings {
  @override
  void dependencies() {
    // 异步初始化依赖
    ...
    // 注册页面逻辑控制器
    Get.lazyPut(() => TkPaySetPassWordLogic());
  }
  ...
  Future<void> _initializeAsyncDependencies() async {
    try {
      ...
      print('TkPaySetPassWordBinding: 异步依赖初始化完成'); // 调试信息
    } catch (e) {
      print('TkPaySetPassWordBinding: 异步依赖初始化失败: $e'); // 调试信息
    }
  }
}
