...
mixin _$StrategyItem {
  ...
  /// Serializes this StrategyItem to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of StrategyItem
...
/// @nodoc
abstract class _$$StrategyItemImplCopyWith<$Res>
    implements $StrategyItemCopyWith<$Res> {
  factory _$$StrategyItemImplCopyWith(
          _$StrategyItemImpl value, $Res Function(_$StrategyItemImpl) then) =
      __$$StrategyItemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'id') String id,
...
/// @nodoc
class __$$StrategyItemImplCopyWithImpl<$Res>
    extends _$StrategyItemCopyWithImpl<$Res, _$StrategyItemImpl>
    implements _$$StrategyItemImplCopyWith<$Res> {
  __$$StrategyItemImplCopyWithImpl(
      _$StrategyItemImpl _value, $Res Function(_$StrategyItemImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$StrategyItemImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$StrategyItemImpl implements _StrategyItem {
  const _$StrategyItemImpl(
  ...
  factory _$StrategyItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$StrategyItemImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$StrategyItemImplCopyWith<_$StrategyItemImpl> get copyWith =>
      __$$StrategyItemImplCopyWithImpl<_$StrategyItemImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$StrategyItemImplToJson(
      this,
    );
  }
}
...
abstract class _StrategyItem implements StrategyItem {
  const factory _StrategyItem(
      ...
      @JsonKey(name: 'updatedAt')
      required final String updatedAt}) = _$StrategyItemImpl;

  factory _StrategyItem.fromJson(Map<String, dynamic> json) =
      _$StrategyItemImpl.fromJson;
