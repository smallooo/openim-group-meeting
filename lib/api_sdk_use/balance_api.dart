...
//     try {
//       final queryDTO = CurrencyBalanceQueryDTO(currencyId: currencyId);
//       final result = await _api.getMyBalance(queryDTO);
//       return result?.data;
//     } catch (e) {
...
//     try {
//       final queryDTO = RedPacketDetailQueryDTO(packetNo: packetNo);
//       final result = await _api.getRedPacketDetail(queryDTO);
//       return result?.data;
//     } catch (e) {
