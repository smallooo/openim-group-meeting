...
import '../../tk_app/tk_widgets/tk_w3/text_button_example.dart';
import '../../tk_app/tk_widgets/tk_w4/info_card_example.dart';
import '../../tk_app/tk_widgets/tk_w5/switch_example.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildItemView(
              icon: ImageRes.mineHeaderBg, // 使用现有图标或可以替换为其他图标
              label: '组件测试',
