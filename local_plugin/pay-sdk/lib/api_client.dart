  ...
  static dynamic _deserialize(dynamic value, String targetType,
    ...
    try {
      switch (targetType) {
        ...
        case 'NotifyQueryDTO':
          return NotifyQueryDTO.fromJson(value);
        case 'PersonalPayOrderListQueryDTO':
          return PersonalPayOrderListQueryDTO.fromJson(value);
        case 'PersonalPayOrderOrderNoQueryDTO':
          return PersonalPayOrderOrderNoQueryDTO.fromJson(value);
        case 'PersonalPayOrderPaymentIdQueryDTO':
          return PersonalPayOrderPaymentIdQueryDTO.fromJson(value);
        case 'ResponseResultVoid':
          return ResponseResultVoid.fromJson(value);
        case 'TriggerNotifyDTO':
          return TriggerNotifyDTO.fromJson(value);
        default:
          dynamic match;
          if (value is List &&
