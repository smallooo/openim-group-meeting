...
part 'model/api_resp_list_channel_list_dto.dart';
part 'model/api_resp_list_mch_seller_dto.dart';
...
part 'model/channel_list_dto.dart';
part 'model/channel_list_query_dto.dart';
part 'model/hot_keyword_dto.dart';
part 'model/id_request.dart';
part 'model/mch_seller_dto.dart';
part 'model/mch_shop_dto.dart';
...
part 'model/seller_id_request.dart';
