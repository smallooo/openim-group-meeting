...
class PageResultDTO {
  ...
  @override
  String toString() =>
      'PageResultDTO[total=$total, list=$list, page=$page, size=$size, totalPages=$totalPages]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PageResultDTO[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PageResultDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PageResultDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PageResultDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PageResultDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
