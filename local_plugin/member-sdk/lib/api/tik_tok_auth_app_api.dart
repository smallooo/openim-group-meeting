...
class TikTokAuthAppApi {
  ...
  Future<Response> getTikTokAuthUrlWithHttpInfo(
    TikTokAuthUrlCommand tikTokAuthUrlCommand,
  ) async {
    // ignore: prefer_const_declarations
    final path = r'/app/auth/oauth2/tiktok/auth-url';
  ...
  ///
  /// * [TikTokAuthUrlCommand] tikTokAuthUrlCommand (required):
  Future<ApiRespString?> getTikTokAuthUrl(
    TikTokAuthUrlCommand tikTokAuthUrlCommand,
  ) async {
    final response = await getTikTokAuthUrlWithHttpInfo(
  ...
  Future<Response> tiktokCallbackWithHttpInfo(
    TikTokCallbackCommand tikTokCallbackCommand,
  ) async {
    // ignore: prefer_const_declarations
    final path = r'/app/auth/oauth2/tiktok/callback';
  ...
  ///
  /// * [TikTokCallbackCommand] tikTokCallbackCommand (required):
  Future<ApiRespTikTokLoginResponse?> tiktokCallback(
    TikTokCallbackCommand tikTokCallbackCommand,
  ) async {
    final response = await tiktokCallbackWithHttpInfo(
  ...
  Future<Response> tiktokLoginWithHttpInfo(
    TikTokLoginCommand tikTokLoginCommand,
  ) async {
    // ignore: prefer_const_declarations
    final path = r'/app/auth/oauth2/tiktok/login';
  ...
  ///
  /// * [TikTokLoginCommand] tikTokLoginCommand (required):
  Future<ApiRespTikTokLoginResponse?> tiktokLogin(
    TikTokLoginCommand tikTokLoginCommand,
  ) async {
    final response = await tiktokLoginWithHttpInfo(
      tikTokLoginCommand,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
