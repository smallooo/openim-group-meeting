# toklink_member_sdk.api.MemberAppApi
...
# **getCurrentUser**
> ApiRespMemberInfoResponse getCurrentUser(body)

获取当前用户信息

通过Access Token获取当前登录用户的详细信息
...
final api_instance = MemberAppApi();
final body = Object(); // Object | 

try {
    final result = api_instance.getCurrentUser(body);
    print(result);
} catch (e) {
    print('Exception when calling MemberAppApi->getCurrentUser: $e\n');
}
```
...
[**ApiRespMemberInfoResponse**](ApiRespMemberInfoResponse.md)
