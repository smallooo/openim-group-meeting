...
------------- | ------------- | -------------
[**getGoogleAuthUrl**](GoogleAuthAppApi.md#getgoogleauthurl) | **POST** /app/auth/oauth2/google/auth-url | 获取授权URL
[**googleAuthorize**](GoogleAuthAppApi.md#googleauthorize) | **GET** /app/auth/oauth2/google/authorize | 获取Google授权URL
[**googleCallback**](GoogleAuthAppApi.md#googlecallback) | **POST** /app/auth/oauth2/google/callback | Google OAuth2回调
[**googleLogin**](GoogleAuthAppApi.md#googlelogin) | **POST** /app/auth/oauth2/google/login | Google登录


# **getGoogleAuthUrl**
> ApiRespString getGoogleAuthUrl(googleAuthUrlCommand)
...
try {
    final result = api_instance.getGoogleAuthUrl(googleAuthUrlCommand);
    print(result);
} catch (e) {
    print('Exception when calling GoogleAuthAppApi->getGoogleAuthUrl: $e\n');
}
```
...
try {
    api_instance.googleAuthorize();
} catch (e) {
    print('Exception when calling GoogleAuthAppApi->googleAuthorize: $e\n');
}
```
...
# **googleCallback**
> ApiRespGoogleLoginResponse googleCallback(googleLoginCommand)
...
try {
    final result = api_instance.googleCallback(googleLoginCommand);
    print(result);
} catch (e) {
    print('Exception when calling GoogleAuthAppApi->googleCallback: $e\n');
}
```
...
# **googleLogin**
> ApiRespGoogleLoginResponse googleLogin(googleLoginCommand)
...
try {
    final result = api_instance.googleLogin(googleLoginCommand);
    print(result);
} catch (e) {
    print('Exception when calling GoogleAuthAppApi->googleLogin: $e\n');
}
```
