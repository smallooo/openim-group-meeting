...
------------- | ------------- | -------------
[**processMyRefund**](WalletRefundAppApi.md#processmyrefund) | **POST** /wallet-refund/process | 处理我的退款订单
[**verifyPasswordAndRefund**](WalletRefundAppApi.md#verifypasswordandrefund) | **POST** /wallet-refund/verify | 验证支付密码并退款
