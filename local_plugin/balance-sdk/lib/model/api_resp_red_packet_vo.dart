...
class ApiRespRedPacketVO {
  /// Returns a new [ApiRespRedPacketVO] instance.
  ApiRespRedPacketVO({
    this.errCode,
    this.errMsg,
    this.errDlt,
  ...
  /// Returns a new [ApiRespRedPacketVO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiRespRedPacketVO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ApiRespRedPacketVO(
        ...
        data: RedPacketVO.fromJson(json[r'data']),
      );
    }
    return null;
  }
  ...
  static List<ApiRespRedPacketVO> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiRespRedPacketVO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiRespRedPacketVO> mapFromJson(dynamic json) {
    final map = <String, ApiRespRedPacketVO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApiRespRedPacketVO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
