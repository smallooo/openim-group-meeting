# toklink_strategy_sdk.api.TraderAppApi
...
# **applyTrader**
> ApiRespMapStringObject applyTrader(traderApplyDTO)
...
final traderApplyDTO = TraderApplyDTO(); // TraderApplyDTO | 

try {
    final result = api_instance.applyTrader(traderApplyDTO);
    print(result);
} catch (e) {
    print('Exception when calling TraderAppApi->applyTrader: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **traderApplyDTO** | [**TraderApplyDTO**](TraderApplyDTO.md)|  | 
...
try {
    final result = api_instance.getTraderDetail(traderId);
    print(result);
} catch (e) {
    print('Exception when calling TraderAppApi->getTraderDetail: $e\n');
}
```
...
[**ApiRespStrTrader**](ApiRespStrTrader.md)
...
final api_instance = TraderAppApi();
final queryDTO = ; // TraderQueryDTO | 

try {
    final result = api_instance.getTraderList(queryDTO);
    print(result);
} catch (e) {
    print('Exception when calling TraderAppApi->getTraderList: $e\n');
}
```
...
# **getTraderStats**
> ApiRespMapStringObject getTraderStats()
...
try {
    final result = api_instance.getTraderStats();
    print(result);
} catch (e) {
    print('Exception when calling TraderAppApi->getTraderStats: $e\n');
}
```
...
try {
    final result = api_instance.syncTraderStats();
    print(result);
} catch (e) {
    print('Exception when calling TraderAppApi->syncTraderStats: $e\n');
}
```
...
# **updateTraderProfile**
> ApiRespVoid updateTraderProfile(traderUpdateDTO)
...
final api_instance = TraderAppApi();
final traderUpdateDTO = TraderUpdateDTO(); // TraderUpdateDTO | 

try {
    final result = api_instance.updateTraderProfile(traderUpdateDTO);
    print(result);
} catch (e) {
    print('Exception when calling TraderAppApi->updateTraderProfile: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **traderUpdateDTO** | [**TraderUpdateDTO**](TraderUpdateDTO.md)|  | 
