...
class StrategyAppApi {
  ...
  ///
  /// * [TraderStrategyQueryDTO] queryDTO (required):
  Future<Response> getStrategiesByTraderWithHttpInfo(
    int traderId,
  ...
  ///
  /// * [TraderStrategyQueryDTO] queryDTO (required):
  Future<ApiRespIPageTraderStrategyResponseDTO?> getStrategiesByTrader(
    int traderId,
    TraderStrategyQueryDTO queryDTO,
  ) async {
    final response = await getStrategiesByTraderWithHttpInfo(
      traderId,
      queryDTO,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
    ...
    if (response.body.isNotEmpty &&
      ...
      ) as ApiRespIPageTraderStrategyResponseDTO;
    }
    return null;
  }
